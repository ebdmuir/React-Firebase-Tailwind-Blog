...
const NewArticle = (props) => {
    ...
    useEffect(() => {
        if(typeof props.match.params.aid !== 'undefined'){
            ...
            setCurrentLang("")
            setTimeout(() => setCurrentLang("hk"), 100)
    ...
    return (
        <div className="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative h-full ">
            ...
            <div className="flex">
                ...
                <div>
                    <button
                        className={["rounded w-16 px-4 py-2", currentLang === "hk" ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"].join(" ")}
                        onClick={() => {
                            setCurrentLang("")
                            setTimeout(() => setCurrentLang("hk"), 100)
                        }}
                    ...
                    <button
                        className={["rounded w-16 px-4 py-2", currentLang === "en" ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"].join(" ")}
                        onClick={() => {
                            setCurrentLang("")
                            setTimeout(() => setCurrentLang("en"), 100)
                        }}
                    >
                        ENG
                    </button>
            ...
            <div className="my-4">
                <input type='text' name='articleTitle' id='articleTitle' placeholder='title'
                       ...
                       onChange={(e) => {
                           setNewArticle({
                               ...newArticle,
                               [currentLang === "hk" ? "titleCHI" : "title"]: e.target.value
                           })
                       }}
                       value={currentLang === "hk" ? newArticle.titleCHI : newArticle.title}
                />
            </div>
            ...
            >
                {
                    ...
                    <ReactQuill
                        // ref={(el) => quillRef = el}
                        defaultValue={currentLang === "hk" ? newArticle.contentCHI : newArticle.content}
                        onChange={(e) => {
                            setNewArticle({
                                ...newArticle,
                                [currentLang === "hk" ? "contentCHI" : "content"]: e
                            })
                        }}
                        theme='snow'
                        modules={modules}
